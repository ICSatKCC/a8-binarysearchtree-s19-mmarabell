...
public abstract class Pokemon implements Comparable<Pokemon> {
  ...
  * @throws PokemonException Prevents no names.
  */
   public void setName(String newName) throws PokemonException {
      if (newName.matches("")) { //Throw the exception if name is blank.
         PokemonException ex = new PokemonException();
         ex.setMessage("Pokemon name is blank!");
         throw ex;
      }
      else { //The name is ok.
         this.name = newName;
   ...
   */  
   ...
   /**
    * Method to compare the two Pokemon.
    * @param p Used for Pokemon object.
    * @return r Positive or Negative number
    * indicating which Pokemon is greater/weaker.
    */
   public int compareTo(Pokemon p) {
      /**
       * Initialization for first Pokemon.
       */
      /** Set the variable for first Pokemon. */
      ...
      /**
       * Initialization for second Pokemon.
       */
      /** Set the variable for second Pokemon. */
       ...
       */
      /** Variable for the result of comparison. */
      int r = 0;
      if (num1 != num2) { //If the numbers of the Pokemon match.
         r = num1 - num2; //r becomes 0.
      }
      else {
         /** Compare the names of the two Pokemon. */
         r = name1.toUpperCase().compareTo(name2.toUpperCase());
         if (r == 0) { //Check if result is equal to 0.
            if (hP1 != hP2) { //If the HP of the Pokemon match.
               r = hP1 - hP2; //r becomes 0.
            }
            else {
               if (cP1 != cP2) { //If the CP of the Pokemon match.
                  r = cP1 - cP2; //r becomes 0.
               }
               else {
                  /** Compare the fast attacks of the two Pokemon. */
                  r = fastAttack1.compareTo(fastAttack2);
                  if (r == 0) { //Check if result is equal to 0.
                     /** Compare the special attacks of the two Pokemon. */
   ...
   /**
    * Method to check if the two Pokemon are equal.
    * @param p Used for Pokemon object.
    * @return true or false depending on the Pokemon data.
    */
